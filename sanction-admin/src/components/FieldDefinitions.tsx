...
const INITIAL_DATA: TableSection[] = [
  {
    ...
    rows: [
      ...
      { id: '4', name: '태그', type: 'string[]', desc: '유저에게 부여된 라벨 목록', sort: 'X', note: '외부거래, 부적절 콘텐츠, 커뮤니티 질서 위반, 상품판매 위반, 라이브 위반, 거래 이슈, 계정 어뷰징, 기타. 복수 가능' },
  ...
  },
  {
    ...
    rows: [
      { id: '1', code: 'EXTERNAL_TRADE', text: '외부거래', desc: '플랫폼 밖 거래 시도/유도' },
      { id: '2', code: 'INAPPROPRIATE_CONTENT', text: '부적절 콘텐츠', desc: '욕설·음란·폭력 등 언어 자체 문제' },
      { id: '3', code: 'COMMUNITY_DISRUPTION', text: '커뮤니티 질서 위반', desc: '비방·담합·구매방해 등 대상이 있는 질서 파괴' },
      { id: '4', code: 'PRODUCT_SELLING', text: '상품판매 위반', desc: '금지/문제성 상품 판매' },
      { id: '5', code: 'LIVE_VIOLATION', text: '라이브 위반', desc: '라이브 송출 관련 위반' },
      { id: '6', code: 'TRANSACTION_ISSUE', text: '거래 이슈', desc: '거래 프로세스 문제 (배송/파기/정산)' },
      { id: '7', code: 'ACCOUNT_ABUSE', text: '계정 어뷰징', desc: '계정 수준 악용 (부계정/대여/닉네임)' },
      { id: '8', code: 'OTHER', text: '기타', desc: '미분류 또는 사유 미기입' },
    ],
  },
  {
    id: 'detail-panel',
